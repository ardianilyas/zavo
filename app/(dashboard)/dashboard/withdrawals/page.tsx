...
import { WithdrawalsTable } from "@/features/wallet/components/withdrawals-table";
    ...
    <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
      <div className="flex flex-col space-y-2">
        ...
        <p className="text-muted-foreground">
          View your past payouts and status.
        </p>
      </div>
      <WithdrawalsTable creatorId={creatorProfile.id} />
    </div>
  );
}
